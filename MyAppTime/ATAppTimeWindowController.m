...
@interface ATAppTimeWindowController () {
    ATCurrentDisplayMode _currentDisplayMode;
}

@end

@implementation ATAppTimeWindowController
...
- (void)windowWillClose:(NSNotification *)notification {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ATAppTimeWindowHasClosed" object:nil userInfo:@{@"self":self}];
}
